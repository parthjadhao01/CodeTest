...
export type GetContestProblemAggregateType<T extends ContestProblemAggregateArgs> = {
    [P in keyof T & keyof AggregateContestProblem]: P extends '_count' | 'count' ? T[P] extends true ? number : Prisma.GetScalarType<T[P], AggregateContestProblem[P]> : Prisma.GetScalarType<T[P], AggregateContestProblem[P]>;
};
...
type GetContestProblemGroupByPayload<T extends ContestProblemGroupByArgs> = Prisma.PrismaPromise<Array<Prisma.PickEnumerable<ContestProblemGroupByOutputType, T['by']> & {
    [P in ((keyof T) & (keyof ContestProblemGroupByOutputType))]: P extends '_count' ? T[P] extends boolean ? number : Prisma.GetScalarType<T[P], ContestProblemGroupByOutputType[P]> : Prisma.GetScalarType<T[P], ContestProblemGroupByOutputType[P]>;
}>>;
export type ContestProblemWhereInput = {
    ...
    constestId?: Prisma.StringFilter<"ContestProblem"> | string;
    problemId?: Prisma.StringFilter<"ContestProblem"> | string;
    createdAt?: Prisma.DateTimeFilter<"ContestProblem"> | Date | string;
    updatedAt?: Prisma.DateTimeFilter<"ContestProblem"> | Date | string;
    index?: Prisma.IntFilter<"ContestProblem"> | number;
    solved?: Prisma.IntFilter<"ContestProblem"> | number;
...
export type ContestProblemWhereUniqueInput = Prisma.AtLeast<{
    constestId_problemId?: Prisma.ContestProblemConstestIdProblemIdCompoundUniqueInput;
    AND?: Prisma.ContestProblemWhereInput | Prisma.ContestProblemWhereInput[];
    OR?: Prisma.ContestProblemWhereInput[];
    NOT?: Prisma.ContestProblemWhereInput | Prisma.ContestProblemWhereInput[];
    id?: Prisma.StringFilter<"ContestProblem"> | string;
...
export type ContestProblemScalarWhereWithAggregatesInput = {
    ...
    constestId?: Prisma.StringWithAggregatesFilter<"ContestProblem"> | string;
    problemId?: Prisma.StringWithAggregatesFilter<"ContestProblem"> | string;
    createdAt?: Prisma.DateTimeWithAggregatesFilter<"ContestProblem"> | Date | string;
    updatedAt?: Prisma.DateTimeWithAggregatesFilter<"ContestProblem"> | Date | string;
    index?: Prisma.IntWithAggregatesFilter<"ContestProblem"> | number;
    solved?: Prisma.IntWithAggregatesFilter<"ContestProblem"> | number;
};
export type ContestProblemCreateInput = {
    ...
    problem: Prisma.ProblemCreateNestedOneWithoutContestsInput;
};
...
export type ContestProblemUpdateInput = {
    ...
    problem?: Prisma.ProblemUpdateOneRequiredWithoutContestsNestedInput;
};
export type ContestProblemUncheckedUpdateInput = {
    id?: Prisma.StringFieldUpdateOperationsInput | string;
    constestId?: Prisma.StringFieldUpdateOperationsInput | string;
...
export type ContestProblemConstestIdProblemIdCompoundUniqueInput = {
    constestId: string;
    problemId: string;
};
...
export type ContestProblemOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "constestId" | "problemId" | "createdAt" | "updatedAt" | "index" | "solved", ExtArgs["result"]["contestProblem"]>;
...
export type ContestProblemCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = Omit<ContestProblemFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface ContestProblemDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
    [K: symbol]: {
        types: Prisma.TypeMap<ExtArgs>['model']['ContestProblem'];
        meta: {
            name: 'ContestProblem';
        };
    };
     ...
     * })
    **/
    count<T extends ContestProblemCountArgs>(args?: Prisma.Subset<T, ContestProblemCountArgs>): Prisma.PrismaPromise<T extends runtime.Types.Utils.Record<'select', any> ? T['select'] extends true ? number : Prisma.GetScalarType<T['select'], ContestProblemCountAggregateOutputType> : number>;
    /**
    ...
    **/
     ...
     *
    **/
    groupBy<T extends ContestProblemGroupByArgs, HasSelectOrTake extends Prisma.Or<Prisma.Extends<'skip', Prisma.Keys<T>>, Prisma.Extends<'take', Prisma.Keys<T>>>, OrderByArg extends Prisma.True extends HasSelectOrTake ? {
        ...
        [P in OrderFields]: P extends ByFields ? never : `Error: Field "${P}" in "orderBy" needs to be provided in "by"`;
    }[OrderFields]>(args: Prisma.SubsetIntersection<T, ContestProblemGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetContestProblemGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>;
    /**
...
export interface ContestProblemFieldRefs {
    ...
    readonly constestId: Prisma.FieldRef<"ContestProblem", 'String'>;
    readonly problemId: Prisma.FieldRef<"ContestProblem", 'String'>;
    readonly createdAt: Prisma.FieldRef<"ContestProblem", 'DateTime'>;
    readonly updatedAt: Prisma.FieldRef<"ContestProblem", 'DateTime'>;
    readonly index: Prisma.FieldRef<"ContestProblem", 'Int'>;
    readonly solved: Prisma.FieldRef<"ContestProblem", 'Int'>;
}
/**
...
export {};
//# sourceMappingURL=ContestProblem.d.ts.map