...
// @ts-nocheck 
/*
 * This file exports the `ContestPoints` model and its related types.
 *
...
export type GetContestPointsAggregateType<T extends ContestPointsAggregateArgs> = {
      [P in keyof T & keyof AggregateContestPoints]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateContestPoints[P]>
    : Prisma.GetScalarType<T[P], AggregateContestPoints[P]>
}
...
type GetContestPointsGroupByPayload<T extends ContestPointsGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<ContestPointsGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof ContestPointsGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], ContestPointsGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], ContestPointsGroupByOutputType[P]>
      }
    >
  >
...
export type ContestPointsCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<ContestPointsFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface ContestPointsDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['ContestPoints'], meta: { name: 'ContestPoints' } }
  /**
   ...
   * })
  **/
  count<T extends ContestPointsCountArgs>(
    args?: Prisma.Subset<T, ContestPointsCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], ContestPointsCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends ContestPointsGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, ContestPointsGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetContestPointsGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
